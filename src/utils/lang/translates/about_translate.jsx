export const about_translate = {
    ru:{
        ...
        s2:{
            title:`Деятельность компании <span className="roboto">«ZARHAL GROUP»</span>  в текстильной отрасли началась в 2002 году.`,
            title_desc:`С первых дней своего основания компания выбрала приоритетными принципами качество, доверие и современный подход, на основе которых успешно ведёт свою деятельность.`,
            box_title:`В настоящее время в состав <span className="roboto">«ZARHAL GROUP»</span>  входят несколько ключевых предприятий. В частности:`,
            p1:`ООО <span className="roboto">«Kamalak Shabnam Teks»</span>  начало свою деятельность в 2010 году. На
                                            сегодняшний день производственная мощность предприятия составляет 3 500 тонн
                                            пряжи и 32,0 млн кв. метров тканых материалов в год. <br/>
                                            <a target="_blank" href="https://lightca.news/tag/curt-bauer-2/">https://lightca.news/tag/curt-bauer-2/</a>
                                        `,
        ...
        s3:{
            subtitle:"Производственная гибкость",
            title:`Выходим на зарубежные рынки`,
            i1:{
                t:`Экспортный потенциал`,
                d:`Ежегодно мы поставляем продукцию на рынки Европы и СНГ, достигая объёма до 20 млн евро в год — благодаря качеству, которому доверяют.`
            },
            i2:{
                t:`Гибкость в производстве`,
                d:`Можем выпускать ткани разной плотности — от 100 до 350 г/м², и шириной до 400 см.`
            },
            i3:{
                t:`Экологичный подход`,
                d:`Экологичность в деталях: <br/>
                              Только безопасные красители и современные технологии, щадящие природу — на всех этапах производства.
                          `
            },
        },
        s5:{
            subtitle:`Рост проекта`,
            title:`Динамика развития и планы`,
            p:`Проект демонстрирует уверенный рост и приближается к финальной стадии подготовки к запуску. Мы
                        ...
                        международном рынке как о надёжном производителе текстильной продукции.`,
            i1:"Подготовка к запуску ",
            i2:"Готовность к экспорту "
        },
        s6:{
            fabric:" Наши фабрики",
            subtitle:"Прогресс",
            title:"Наша команда в работе!"
        },
    },
    en:{
        header:{
        ...
        s2:{
            title:`The activities of ZARHAL GROUP in the textile industry began in 2002.`,
            title_desc:`From the very first days of its establishment, the company has chosen quality, trust, and a modern approach as its core principles, which continue to drive its successful operations.`,
            box_title:`At present, ZARHAL GROUP includes several key enterprises, in particular:`,
            p1:`LLC “Kamalak Shabnam Teks” began its operations in 2010. Today, the company’s production capacity reaches 3,500 tons of yarn and 32.0 million square meters of woven fabrics per year. <br/>
                                            <a target="_blank" href="https://lightca.news/tag/curt-bauer-2/">https://lightca.news/tag/curt-bauer-2/</a>`,
        ...
        s3:{
            subtitle:"Production Flexibility",
            title:`Expanding into International Markets`,
            i1:{
                t:`Export Potential`,
                d:`Every year, we supply our products to the markets of Europe and the CIS, reaching volumes of up to €20 million annually — thanks to the quality our customers trust.`
            },
            i2:{
                t:`Production Flexibility`,
                d:`We can produce fabrics with different densities — from 100 to 350 g/m², and widths of up to 400 cm.`
            },
            i3:{
                t:`Eco-Friendly Approach`,
                d:`Sustainability in every detail: <br/>
Only safe dyes and modern, environmentally friendly technologies are used — at every stage of production.
                          `
            },
        },
        s5:{
            subtitle:`Project Growth`,
            title:`Development Dynamics and Plans`,
            p:`The project is showing steady growth and is approaching the final stage of its launch preparation. We are actively investing in modern technological equipment, developing team expertise, and expanding our export potential. All of this enables us to soon present ourselves on the international market as a reliable textile manufacturer.`,
            i1:"Launch Preparation",
            i2:"Export Readiness"
        },

        s6:{
            fabric:"Our Factories",
            subtitle:"Progress",
